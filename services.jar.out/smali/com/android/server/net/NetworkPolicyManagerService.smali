...
.field volatile mLastUserSetting:Z
...
.field volatile mZeroBalanceRestricted:Z
...
.method public constructor <init>(Landroid/content/Context;Landroid/app/IActivityManager;Landroid/os/IPowerManager;Landroid/net/INetworkStatsService;Landroid/os/INetworkManagementService;Landroid/util/TrustedTime;Ljava/io/File;Z)V
    ...
    iput-boolean v1, p0, Lcom/android/server/net/NetworkPolicyManagerService;->mZeroBalanceRestricted:Z
...
.method private enqueueRestrictedNotification(Ljava/lang/String;)V
    ...
    .line 916
    iget-boolean v0, p0, Lcom/android/server/net/NetworkPolicyManagerService;->mZeroBalanceRestricted:Z
...
.method private isUidValidForRulesBrowser(I)Z
    .locals 5
    .param p1, "uid"    # I
    ...
    const v4, #android:bool@config_zero_balance_operator#t
    ...
    const-string v3, "sys.background.data.disable"
    ...
    .line 2069
    const-string v3, "ZeroBalance"

    const-string v4, "In Whitelist so allow"
    ...
    .end local v1    # "uidForeground":Z
    :cond_0
    :goto_0
    return v2

    .line 2073
    .restart local v0    # "pkg_name":Ljava/lang/String;
    .restart local v1    # "uidForeground":Z
    :cond_1
    const/4 v2, 0x0
...
.method private readPolicyLocked()V
    ...
    iput-boolean v4, v0, Lcom/android/server/net/NetworkPolicyManagerService;->mLastUserSetting:Z
    :try_end_7
...
.method public blockAllData(Z)V
    .locals 3
    .param p1, "isBlockAllData"    # Z
    ...
    invoke-interface {v1, p1}, Landroid/os/INetworkManagementService;->setBlockAllDataRule(Z)V
    :try_end_0
    .catch Ljava/lang/IllegalStateException; {:try_start_0 .. :try_end_0} :catch_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_1
    ...
    const-string v2, "Problem setting zero balance rules to block all data"
...
.method public getRestrictBackground2()Z
    .locals 3
...
.method public setRestrictBackground(Z)V
    ...
    iput-boolean v0, p0, Lcom/android/server/net/NetworkPolicyManagerService;->mLastUserSetting:Z
...
.method public setRestrictBackground2(Z)V
    .locals 4
    .param p1, "restrictBackground"    # Z
    ...
    .line 1698
    iput-boolean p1, p0, Lcom/android/server/net/NetworkPolicyManagerService;->mZeroBalanceRestricted:Z
    ...
    :try_start_0
    iget-boolean v0, p0, Lcom/android/server/net/NetworkPolicyManagerService;->mLastUserSetting:Z
...
.method updateRulesForUidLocked(I)V
    ...
    :goto_1
    #test wenxiangli
    #invoke-direct {p0, p1}, Lcom/android/server/net/NetworkPolicyManagerService;->isUidValidForRulesBrowser(I)Z
