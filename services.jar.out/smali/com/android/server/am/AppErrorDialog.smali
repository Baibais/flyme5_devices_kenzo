...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/am/ActivityManagerService;Lcom/android/server/am/AppErrorResult;Lcom/android/server/am/ProcessRecord;)V
    ...
    .line 76
    :cond_0
    const-string v3, "com.longcheertel.cit"
    ...
    .line 78
    invoke-direct {p0}, Lcom/android/server/am/AppErrorDialog;->restoreFlag()V
...
.method private restoreFlag()V
    ...
    :try_start_0
    const-string v1, "zhoumingliang"

    new-instance v2, Ljava/lang/StringBuilder;

    invoke-direct {v2}, Ljava/lang/StringBuilder;-><init>()V

    const-string v3, "isTcltest=="

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    invoke-interface {v0}, Landroid/view/IWindowManager;->getTestFlag()Z
    ...
    invoke-interface {v0, v1}, Landroid/view/IWindowManager;->setTestFlag(Z)V
    :try_end_0
