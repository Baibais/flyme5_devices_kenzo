...
.field private mDialExtras:Landroid/os/Bundle;
...
.method constructor <init>(Landroid/content/Context;Lcom/android/ims/ImsCall;Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;Lcom/android/internal/telephony/imsphone/ImsPhoneCall;ZLcom/android/internal/telephony/Call$State;Ljava/lang/String;)V
    ...
    iput-object v5, p0, Lcom/android/internal/telephony/imsphone/ImsPhoneConnection;->mDialExtras:Landroid/os/Bundle;
    ...
    .line 142
    iget-object v3, v1, Lcom/android/ims/ImsCallProfile;->mMediaProfile:Lcom/android/ims/ImsStreamMediaProfile;
    ...
    .line 144
    invoke-direct {p0, v3}, Lcom/android/internal/telephony/imsphone/ImsPhoneConnection;->getAudioQualityFromMediaProfile(Lcom/android/ims/ImsStreamMediaProfile;)I
    ...
    :cond_0
    :try_start_0
    invoke-virtual {p0}, Lcom/android/internal/telephony/imsphone/ImsPhoneConnection;->getCallCapability()I
    ...
    .line 157
    invoke-static {v4, v0}, Lcom/android/internal/telephony/imsphone/ImsPhoneConnection;->applyRemoteCallCapability(Lcom/android/ims/ImsCallProfile;I)I

    move-result v0

    .line 159
    :cond_2
    invoke-virtual {p0, v0}, Lcom/android/internal/telephony/imsphone/ImsPhoneConnection;->setCallCapability(I)V
    :try_end_0
...
.method constructor <init>(Landroid/content/Context;Ljava/lang/String;Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;Lcom/android/internal/telephony/imsphone/ImsPhoneCall;Landroid/os/Bundle;)V
    ...
    .line 61
    iput-object v6, p0, Lcom/android/internal/telephony/imsphone/ImsPhoneConnection;->mDialExtras:Landroid/os/Bundle;
    ...
    .line 224
    iput-object p5, p0, Lcom/android/internal/telephony/imsphone/ImsPhoneConnection;->mDialExtras:Landroid/os/Bundle;
...
.method public getDialExtras()Landroid/os/Bundle;
    .locals 1

    .prologue
    .line 823
    iget-object v0, p0, Lcom/android/internal/telephony/imsphone/ImsPhoneConnection;->mDialExtras:Landroid/os/Bundle;
...
.method public hangupWithReason(I)V
    ...
    invoke-virtual {v0, p0, p1}, Lcom/android/internal/telephony/imsphone/ImsPhoneCallTracker;->hangupWithReason(Lcom/android/internal/telephony/imsphone/ImsPhoneConnection;I)V
...
.method update(Lcom/android/ims/ImsCall;)Z
    ...
    .line 715
    :try_start_0
    invoke-virtual/range {p0 .. p0}, Lcom/android/internal/telephony/imsphone/ImsPhoneConnection;->getCallCapability()I
    ...
    .line 720
    invoke-static {v7, v5}, Lcom/android/internal/telephony/imsphone/ImsPhoneConnection;->applyLocalCallCapability(Lcom/android/ims/ImsCallProfile;I)I
    ...
    invoke-static {v0, v5}, Lcom/android/internal/telephony/imsphone/ImsPhoneConnection;->applyRemoteCallCapability(Lcom/android/ims/ImsCallProfile;I)I
    ...
    invoke-virtual {v0, v5}, Lcom/android/internal/telephony/imsphone/ImsPhoneConnection;->setCallCapability(I)V
    ...
    .line 737
    .local v13, "newCallSubstate":I
    if-eq v4, v13, :cond_3

    .line 738
    move-object/from16 v0, p0

    invoke-virtual {v0, v13}, Lcom/android/internal/telephony/imsphone/ImsPhoneConnection;->setCallSubstate(I)V
    :try_end_0
    .catch Lcom/android/ims/ImsException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .end local v13    # "newCallSubstate":I
    ...
    iput v11, v0, Lcom/android/internal/telephony/imsphone/ImsPhoneConnection;->mCnapNamePresentation:I
    ...
    .line 796
    :cond_a
    iget-object v8, v3, Lcom/android/ims/ImsCallProfile;->mMediaProfile:Lcom/android/ims/ImsStreamMediaProfile;
    ...
    invoke-virtual {v0, v12}, Lcom/android/internal/telephony/imsphone/ImsPhoneConnection;->setAudioQuality(I)V
    ...
    .end local v11    # "namep":I
    .end local v12    # "newAudioQuality":I
    ...
    iput-boolean v9, v0, Lcom/android/internal/telephony/imsphone/ImsPhoneConnection;->mMptyState:Z

    .line 814
    .end local v3    # "callProfile":Lcom/android/ims/ImsCallProfile;
    .end local v9    # "mptyState":Z
    :cond_c
    return v6
    ...
    iput-object v10, v0, Lcom/android/internal/telephony/imsphone/ImsPhoneConnection;->mCnapName:Ljava/lang/String;
