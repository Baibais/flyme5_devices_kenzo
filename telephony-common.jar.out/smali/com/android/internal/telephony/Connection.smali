...
.field private mCallCapability:I
...
.method public getCallCapability()I
    .locals 1

    .prologue
    .line 509
    iget v0, p0, Lcom/android/internal/telephony/Connection;->mCallCapability:I
...
.method public abstract hangupWithReason(I)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/android/internal/telephony/CallStateException;
        }
...
.method public setCallCapability(I)V
    .locals 3
    .param p1, "capability"    # I

    .prologue
    .line 583
    iget v2, p0, Lcom/android/internal/telephony/Connection;->mCallCapability:I

    if-eq v2, p1, :cond_0

    .line 584
    iput p1, p0, Lcom/android/internal/telephony/Connection;->mCallCapability:I
    ...
    invoke-interface {v1, v2}, Lcom/android/internal/telephony/Connection$Listener;->onCallCapabilityChanged(I)V
