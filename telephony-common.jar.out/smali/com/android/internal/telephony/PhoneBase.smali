...
.field protected static final EVENT_GET_EXTERNAL_VERSION:I = 0x29

.field protected static final EVENT_GET_IMEISV_DONE:I = 0xa

.field protected static final EVENT_GET_IMEI_DONE:I = 0x9

.field protected static final EVENT_GET_INTERNAL_VERSION:I = 0x2a
...
.field protected static final EVENT_OEM_CMD_DONE:I = 0x28
...
.field private static mVersionRead:Z
...
.field mOemResult:Lcom/android/internal/telephony/SmsRawData;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/internal/telephony/PhoneBase;->mVersionRead:Z
...
.method protected constructor <init>(Ljava/lang/String;Lcom/android/internal/telephony/PhoneNotifier;Landroid/content/Context;Lcom/android/internal/telephony/CommandsInterface;ZI)V
    ...
    iput-object v2, p0, Lcom/android/internal/telephony/PhoneBase;->mLock:Ljava/lang/Object;
    ...
    .line 492
    sget-boolean v2, Lcom/android/internal/telephony/PhoneBase;->mVersionRead:Z

    if-nez v2, :cond_1

    .line 493
    invoke-direct {p0}, Lcom/android/internal/telephony/PhoneBase;->readWriteExternalVersionInformation()V

    .line 494
    invoke-direct {p0}, Lcom/android/internal/telephony/PhoneBase;->readWriteInternalVersionInformation()V

    .line 495
    invoke-direct {p0}, Lcom/android/internal/telephony/PhoneBase;->writeTouchPadVersionInformation()V

    .line 496
    sput-boolean v6, Lcom/android/internal/telephony/PhoneBase;->mVersionRead:Z
...
.method private readWriteExternalVersionInformation()V
    .locals 11
    ...
    .line 2581
    const-string v6, "ro.build.version.external"
    ...
    invoke-static {v5, v8, v0, v10, v6}, Ljava/lang/System;->arraycopy([BI[BII)V
    ...
    .line 2595
    .local v1, "input":Lcom/android/internal/telephony/SmsRawData;
    iget-object v6, p0, Lcom/android/internal/telephony/PhoneBase;->mCi:Lcom/android/internal/telephony/CommandsInterface;

    invoke-interface {v6, v1, v3}, Lcom/android/internal/telephony/CommandsInterface;->lctOemCommand(Lcom/android/internal/telephony/SmsRawData;Landroid/os/Message;)V

    .line 2596
    return-void
.end method

.method private readWriteInternalVersionInformation()V
    .locals 10
    ...
    .line 2599
    const-string v6, "ro.build.version.internal"
    ...
    invoke-static {v5, v8, v0, v6, v7}, Ljava/lang/System;->arraycopy([BI[BII)V
...
.method private writeTouchPadVersionInformation()V
    .locals 10
    ...
    const-string v6, "/sys/android_tp/tp_info"

    invoke-direct {v3, v6}, Ljava/io/File;-><init>(Ljava/lang/String;)V

    .line 2563
    .local v3, "localFile":Ljava/io/File;
    const-string v6, "zhoumingliang"

    const-string v7, "writeTouchPadVersionInformation"
    ...
    .line 2565
    .local v4, "localFileInputStream":Ljava/io/FileInputStream;
    const/4 v6, 0x0
    ...
    .end local v4    # "localFileInputStream":Ljava/io/FileInputStream;
    :goto_0
    aput-byte v9, v0, v8
    ...
    .line 2577
    .local v2, "input":Lcom/android/internal/telephony/SmsRawData;
    iget-object v6, p0, Lcom/android/internal/telephony/PhoneBase;->mCi:Lcom/android/internal/telephony/CommandsInterface;

    const/4 v7, 0x0

    invoke-interface {v6, v2, v7}, Lcom/android/internal/telephony/CommandsInterface;->lctOemCommand(Lcom/android/internal/telephony/SmsRawData;Landroid/os/Message;)V

    .line 2578
    return-void

    .line 2567
    .end local v2    # "input":Lcom/android/internal/telephony/SmsRawData;
    :catch_0
    move-exception v1
    ...
    const-string v7, "File /sys/android_tp/tp_info not found!"
    ...
    const-string v7, "File I/O error:"
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    .line 640
    .restart local v0    # "ar":Landroid/os/AsyncResult;
    iget-object v8, p0, Lcom/android/internal/telephony/PhoneBase;->mLock:Ljava/lang/Object;
    ...
    invoke-direct {v9, v7}, Lcom/android/internal/telephony/SmsRawData;-><init>([B)V

    iput-object v9, p0, Lcom/android/internal/telephony/PhoneBase;->mOemResult:Lcom/android/internal/telephony/SmsRawData;

    .line 647
    :goto_1
    iget-object v7, p0, Lcom/android/internal/telephony/PhoneBase;->mLock:Ljava/lang/Object;
    ...
    const-string v9, "EVENT_OEM_CMD_DONE exception return null"
    ...
    iput-object v7, p0, Lcom/android/internal/telephony/PhoneBase;->mOemResult:Lcom/android/internal/telephony/SmsRawData;
    :try_end_2
    ...
    .line 657
    :cond_7
    const-string v7, "zhoumingliang"

    new-instance v8, Ljava/lang/StringBuilder;

    invoke-direct {v8}, Ljava/lang/StringBuilder;-><init>()V

    const-string v9, "Lversion="
    ...
    .line 658
    const-string v7, "persist.radio.version.mpssout"

    new-instance v8, Ljava/lang/String;

    invoke-direct {v8, v6, v10, v4}, Ljava/lang/String;-><init>([BII)V
    ...
    .line 668
    :cond_9
    const-string v7, "persist.radio.version.mpssin"
...
.method public lctOemCommand(Lcom/android/internal/telephony/SmsRawData;)Lcom/android/internal/telephony/SmsRawData;
    .locals 5
    .param p1, "input"    # Lcom/android/internal/telephony/SmsRawData;
    ...
    invoke-interface {v2, p1, v1}, Lcom/android/internal/telephony/CommandsInterface;->lctOemCommand(Lcom/android/internal/telephony/SmsRawData;Landroid/os/Message;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    .line 2622
    :try_start_1
    iget-object v2, p0, Lcom/android/internal/telephony/PhoneBase;->mLock:Ljava/lang/Object;
    ...
    .line 2628
    iget-object v2, p0, Lcom/android/internal/telephony/PhoneBase;->mOemResult:Lcom/android/internal/telephony/SmsRawData;
    ...
    const-string v4, "waiting lock fail: "
