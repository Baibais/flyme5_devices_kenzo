...
.field private static final NV_IMEI_I:I = 0x226

.field private static final NV_MEID_I:I = 0x15de
...
.method private readNVItems(II)[B
    .locals 9
    .param p1, "item"    # I
    .param p2, "subs"    # I
    ...
    invoke-interface {v5, v2, p2}, Lcom/android/internal/telephony/ITelephony;->lctOemCommand([BI)[B
    ...
    invoke-static {v3, v5, v4, v6, v1}, Ljava/lang/System;->arraycopy([BI[BII)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0

    .line 4270
    .end local v1    # "i":I
    .end local v3    # "output1":[B
    .end local v4    # "output2":[B
    :goto_1
    return-object v4

    .line 4260
    .restart local v1    # "i":I
    .restart local v3    # "output1":[B
    :cond_1
    if-ne p1, v8, :cond_2
    ...
    const-string v6, "exception on readNVItems: "
