...
.method public onServiceDisconnected(I)V
    ...
    # setter for: Landroid/media/AudioService;->mA2dp:Landroid/bluetooth/BluetoothA2dp;
    invoke-static {v0, v1}, Landroid/media/AudioService;->access$3402(Landroid/media/AudioService;Landroid/bluetooth/BluetoothA2dp;)Landroid/bluetooth/BluetoothA2dp;
    ...
    # getter for: Landroid/media/AudioService;->mConnectedDevicesList:Ljava/util/ArrayList;
    invoke-static {v2}, Landroid/media/AudioService;->access$3800(Landroid/media/AudioService;)Ljava/util/ArrayList;
    ...
    # getter for: Landroid/media/AudioService;->mConnectedDevicesList:Ljava/util/ArrayList;
    invoke-static {v0}, Landroid/media/AudioService;->access$3800(Landroid/media/AudioService;)Ljava/util/ArrayList;
    ...
    # invokes: Landroid/media/AudioService;->checkSendBecomingNoisyIntent(II)I
    invoke-static {v0, v1, v2}, Landroid/media/AudioService;->access$3600(Landroid/media/AudioService;II)I
    ...
    const-string/jumbo v1, "onServiceDisconnected: Remove connected device"
    ...
    # invokes: Landroid/media/AudioService;->queueMsgUnderWakeLock(Landroid/os/Handler;IIILjava/lang/Object;I)V
    invoke-static/range {v0 .. v6}, Landroid/media/AudioService;->access$3700(Landroid/media/AudioService;Landroid/os/Handler;IIILjava/lang/Object;I)V
    ...
    const-string v3, "Hfp service disconnects, update device to NONE"
    ...
    invoke-static {v0, v3}, Landroid/media/AudioService;->access$4002(Landroid/media/AudioService;I)I
    ...
    # invokes: Landroid/media/AudioService;->sendMsg(Landroid/os/Handler;IIIILjava/lang/Object;I)V
    invoke-static/range {v7 .. v13}, Landroid/media/AudioService;->access$100(Landroid/os/Handler;IIIILjava/lang/Object;I)V
