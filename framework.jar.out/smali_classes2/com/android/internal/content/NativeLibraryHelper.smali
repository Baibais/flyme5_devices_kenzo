...
.method public static copyNativeBinariesForSupportedAbi(Lcom/android/internal/content/NativeLibraryHelper$Handle;Ljava/io/File;[Ljava/lang/String;Z)I
    ...
    .line 296
    .local v5, "secondAbiList":[Ljava/lang/String;
    ...
    invoke-static {p2, v7, v5, v8, v9}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V

    .line 297
    invoke-static {p0, v5}, Lcom/android/internal/content/NativeLibraryHelper;->findSupportedAbi(Lcom/android/internal/content/NativeLibraryHelper$Handle;[Ljava/lang/String;)I

    move-result v4

    .line 298
    .local v4, "secondAbi":I
    if-ltz v4, :cond_0
    ...
    .end local v4    # "secondAbi":I
    .end local v5    # "secondAbiList":[Ljava/lang/String;
    ...
    .line 324
    .restart local v3    # "isaSubdir":Ljava/io/File;
    invoke-static {v3}, Lcom/android/internal/content/NativeLibraryHelper;->createNativeLibrarySubdir(Ljava/io/File;)V
    ...
    .line 309
    .restart local v2    # "instructionSet":Ljava/lang/String;
    .restart local v4    # "secondAbi":I
    .restart local v5    # "secondAbiList":[Ljava/lang/String;
    :cond_1
    move-object v6, p1
